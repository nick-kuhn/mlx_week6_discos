...
"""
    ...
    Generates summaries using the base mode and fine-tuned model and prepares inputs for the reward model.
    ...
    Returns:
        A list of dictionaries, where each dictionary contains:
            ...
            - 'base_summary': The summary generated by the fine-tuned model.
    ...
    2. for each sample:  
    - find reference_summary (the human written one)and call it human_summary. 
    - use fine-tuned model to generate a summary for the given post/prompt and call it finetuned_summary.
    - use base model to generate a summary for the given prost/prompt and call it base_summary.

    3. For each sample, prepare three inputs for the reward model:
    prompt + reference_summary called human_summary
    prompt + base model summary called base_summary 
    prompt + fine-tuned model summary called finetuned_summary
    4. return all three inputs.
